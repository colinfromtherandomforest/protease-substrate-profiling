...
data = readtable("aa_count_procas1.csv");
dim = size(data);
...
writetable(hammingFiltered, 'aa_count_xCFH019_procas1_hammingFiltered.xlsx')

%% Load filtered table, normalize, and sort
hammingFiltered = readtable("aa_count_xCFH019_procas1_hammingFiltered.xlsx");
...
writematrix(CFH442mat, 'xCFH019_procas1_CFH442.xlsx')
writematrix(CFH443mat, 'xCFH019_procas1_CFH443.xlsx')
writematrix(CFH498mat, 'xCFH019_procas1_CFH498.xlsx')
writematrix(CFH499mat, 'xCFH019_procas1_CFH499.xlsx')