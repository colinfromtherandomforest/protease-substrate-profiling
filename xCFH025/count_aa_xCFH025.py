            ...
            with open(x, 'r') as f:
                ...
                for line in f:
                    ...
                    if total_match > 180:
                        ...
                        motif = "TCGAGCTCGGGTGGTTCT"
                        codon_start = read.find(motif.upper())
                        aa_seq = read[codon_start+len(motif)-9:codon_start+len(motif)+132]
                        aa_site = aa_seq.translate()
                        if (str(aa_site)[0:3] == "GGS") and (str(aa_site)[-3:] == "GGS"):
                            P1P1p_list.append((str(aa_site[3:44])+","+str(aa_seq)))
